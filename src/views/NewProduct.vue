<template>
    <ion-page>
        <header class="grid">
            ...
            <div class="col-3">
                <ion-buttons @click="SaveNewProduct()">
                    <ion-button>
...
export default ({
    ...
    methods: {
        ...
        LoadStoreCategory() {
            ...
            axios.post(Global.methods.GetURL() + "/store_category", {
        ...
        SaveNewProduct() {
            ...
            if (this.Image != "") {
                            ...
                            if (this.Offers.length != 0) {
                                this.Offers.forEach((x, index) => {
                                    ...
                                    if (this.Offers.length == (index + 1) && checker == 0) {
                                        ...
                                        axios.post(Global.methods.GetURL() + "/store_save_new_product", Data).then(res => {
                                            if (res.data == 1) {
                                                this.Name = "";
                                                this.Price = "";
                                                this.Description = "";
                ...
                this.openToast("No image uploaded.");
            }
        },
        CloseModal() {
            modalController.dismiss();
